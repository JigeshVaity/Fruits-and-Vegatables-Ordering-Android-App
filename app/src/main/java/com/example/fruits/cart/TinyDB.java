...
public class TinyDB {
    ...
    public ArrayList<FruitModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FruitModel> playerList =  new ArrayList<FruitModel>();

        for(String jObjString : objStrings){
            FruitModel player  = gson.fromJson(jObjString,  FruitModel.class);
    ...
    public void putListObject(String key, ArrayList<FruitModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FruitModel player: playerList){
